...
CREATE TABLE IF NOT EXISTS yii2advanced_test.social_category (
...
CREATE TABLE IF NOT EXISTS yii2advanced_test.social_comment (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS yii2advanced_test.social_migration (
  `version` varchar(180) NOT NULL,
  `apply_time` int(11) DEFAULT NULL,
  PRIMARY KEY (`version`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

CREATE TABLE IF NOT EXISTS yii2advanced_test.social_post (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS yii2advanced_test.social_user (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO yii2advanced_test.social_user (`id`, `username`, `authKey`, `passwordHash`, `passwordResetToken`, `email`, `role`, `status`, `createdAt`, `updatedAt`)
  ...
  WHERE NOT EXISTS (
      SELECT email FROM yii2advanced_test.social_user WHERE email = 'Kronos0041@gmail.com'
  ) LIMIT 1;
